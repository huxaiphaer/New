...
public class MainActivity  extends AccountInformation implements OperationsInterface{
	...
	public static void OnLoadAirtime(double Amount){
		...
		Scanner sc=new Scanner(System.in);  
		System.out.println("Load Airtime  E.g For 500ugx *130*1257384879#, 2000ugx *130*123456789#\t\t\t For 1000ugx *130*1234567879# \n"
				+ "5000ugx *130*1294567879#  , 10,000 ugx *130*2394567879# , 20,000"
				+ "ugx *130*5672567879#");
		String at = sc.next();
		 double AT_1 = 2000.0;
		double AT_2 = 1000.0;
			...
			if(Airtime>PackageAmount && PackageAmount!=0 )
			 {
					...
					System.out.println("Dear Customer, you Have "
	    					...
	    					//final double Balance = a.setBalance(Amount);
	    					 ...
	    					 OnLoadAirtime(Amount);
	    						 ...
	    						 System.out.println("You have already subscribed on Mobile Kibiina "
		 	    					 		+ "with a charge of " + GetPackageAmount()+" /="+
		 	    							 " "+DateWithdraw()+" day(s) left to withdraw");
	    					 }
	    		 ...
	    		 else if(code4.contentEquals("2"))
	    		 {
	    			 ...
	    			 if(ordinary.contentEquals("1"))
	    			 {
	    				 ...
	    				 if(pin2.contentEquals(GetPin(pin2))){
	    					 ...
	    					 System.out.println("You have successfully Subscribed on 2 Weeks and a charge of "+GetPackageAmount()
	    					 +"/="
	    					 );
	    				 ...
	    				 if(pin.contentEquals(GetPin(pin)))
	    				 {
	    					 ...
	    					 SetPackagePeriod(30);
	    					 System.out.println("You have successfully Subscribed on 1 Month "
	    					 		+ " and a charge of "+GetPackageAmount()
	    					 +"/="
	    					 );
		...
		else if (menu_selector.contentEquals("2"))
		{
			...
			if(m.contentEquals("1")){
				...
				if (amount>acc_bal  ){
					...
					System.out.println("You can't transfer your credit to Mobile Money you still have a remaining period of  " +GetPackagePeriod()+ "day(s)");
					LoopBack();
				...
				System.out.println("This "+ amount +" Ugx  Has been transfered to Mobile Money Successfully , your remaining mobile kibiina is "+ AccoutBalance() +"/=");
				LoopBack();
		...
		else if (menu_selector.contentEquals("5"))
		{
			...
			if (save_change.contentEquals("1")){
				...
				if (con.contentEquals("1")){
					...
					System.out.println("You have successfully saved all "
							+ "airtime as Mobile Kibiina credit.");
					LoopBack();
					}
				}
...
else if (menu_selector.contentEquals("2"))
{
			...
			if(m.contentEquals("1")){
				...
				{
					System.out.println("You can't withdraw Money from Mobile Kibiina "
							+ "you are left with "+DateWithdraw()+" day(s) to withdraw");
					LoopBack();
				}
				else{
		 ...
		 if(menu_selector.contentEquals("3"))
		 {
		    ...
		    if(menu_selector.contentEquals("4"))
		    {
		    	...
		    	if(DateWithdraw().equals("0")){
		    		...
		    		System.out.print("Dear customer you can't unsubscribe from "
		    				+ "Mobile Kibiina "
		    				+ "there are " +DateWithdraw()+" day(s) left for you to unsubscribe "
		    						+ "from Mobile Kibiina");
		    		LoopBack();
